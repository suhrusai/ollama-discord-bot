...
OLLAMA_RESPONSE_TIMEOUT = _normalize_int(_get_raw("OLLAMA_RESPONSE_TIMEOUT", 3600), 3600)
OLLAMA_SUMMARY_TIMEOUT = _normalize_int(_get_raw("OLLAMA_SUMMARY_TIMEOUT", 120), 120)
BIRTHDAY_MCP_BASE_URL = _get_raw("BIRTHDAY_MCP_BASE_URL", "http://localhost:8060")
